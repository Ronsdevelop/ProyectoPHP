...
<html lang="es">
    <head>
        <meta charset="utf-8" />
        <title>Perfil - Panaderia Leos</title>
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-xl-4">
                                <div class="card-box text-center">
                                    <img src="../public/assets/images/users/user-1.jpg" class="rounded-circle avatar-lg img-thumbnail"
                                        alt="profile-image">
                                ...
                                <div class="card-box">
                                    ...
                                    <div class="inbox-widget slimscroll" style="max-height: 310px;">
                                        <div class="inbox-item">
                                            <div class="inbox-item-img"><img src="../public/assets/images/users/user-2.jpg" class="rounded-circle" alt=""></div>
                                        ...
                                        <div class="inbox-item">
                                            <div class="inbox-item-img"><img src="../public/assets/images/users/user-3.jpg" class="rounded-circle" alt=""></div>
                                        ...
                                        <div class="inbox-item">
                                            <div class="inbox-item-img"><img src="../public/assets/images/users/user-4.jpg" class="rounded-circle" alt=""></div>
                                        ...
                                        <div class="inbox-item">
                                            <div class="inbox-item-img"><img src="../public/assets/images/users/user-5.jpg" class="rounded-circle" alt=""></div>
                                        ...
                                        <div class="inbox-item">
                                            <div class="inbox-item-img"><img src="../public/assets/images/users/user-6.jpg" class="rounded-circle" alt=""></div>
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane show active" id="timeline">
                                            ...
                                            <div class="border border-light p-2 mb-3">
                                                <div class="media">
                                                    <img class="mr-2 avatar-sm rounded-circle" src="../public/assets/images/users/user-3.jpg"
                                                ...
                                                <img src="../public/assets/images/small/img-1.jpg" alt="post-img" class="rounded mr-1"
                                                    height="60" />
                                                <img src="../public/assets/images/small/img-2.jpg" alt="post-img" class="rounded mr-1"
                                                    height="60" />
                                                <img src="../public/assets/images/small/img-3.jpg" alt="post-img" class="rounded"
                                                    height="60" />
                                            ...
                                            <div class="border border-light p-2 mb-3">
                                                <div class="media">
                                                    <img class="mr-2 avatar-sm rounded-circle" src="../public/assets/images/users/user-4.jpg"
                                                        alt="Generic placeholder image">
                                                    <div class="media-body">
                                                ...
                                                <div class="post-user-comment-box">
                                                    <div class="media">
                                                        ...
                                                        <div class="media-body">
                                                            ...
                                                            <div class="media mt-3">
                                                                <a class="pr-2" href="#">
                                                                    <img src="../public/assets/images/users/user-4.jpg" class="avatar-sm rounded-circle"
                                                                        alt="Generic placeholder image">
                                                                </a>
                                                                <div class="media-body">
                                                    ...
                                                    <div class="media mt-2">
                                                        <a class="pr-2" href="#">
                                                            <img src="../public/assets/images/users/user-1.jpg" class="rounded-circle"
                                            ...
                                            <div class="border border-light p-2 mb-3">
                                                <div class="media">
                                                    <img class="mr-2 avatar-sm rounded-circle" src="../public/assets/images/users/user-6.jpg"
                                                        alt="Generic placeholder image">
                                                    <div class="media-body">
                                                        <h5 class="m-0">Jeremy Tomlinson</h5>
