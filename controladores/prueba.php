  ...
  if(isset($_POST["txtNombres"])) {
    ...
    $ruta ="";
        ...
        if (isset($_FILES["nuevaFoto"]["tmp_name"])) {
            ...
            $rutaBD = "vistas/public/img/usuarios/".$_POST["txtUsuario"]."/".$aleatorio.".jpeg";
            ...
            if ($_FILES["nuevaFoto"]["type"]== "image/png") {
                ...
                $rutaBD = "vistas/public/img/usuarios/".$_POST["txtUsuario"]."/".$aleatorio.".png";
                $origen = imagecreatefromjpeg($_FILES["nuevaFoto"]["tmp_name"]);
                $destino = imagecreatetruecolor($nuevoAncho,$nuevoAlto);
                //imagecopyresized(dst_image,src_image,dst_x,dst_y,src_x,src_y,dst_w,dst_h,src_w,src_h);
                imagecopyresized($destino,$origen,0,0,0,0,$nuevoAncho,$nuevoAlto,$ancho,$alto);
    ...
    if (preg_match('/^[a-zA-Z0-9ñÑáíóúÁÉÍÓÚ ]+$/',$_POST["txtNombres"])) { 
        ...
        if (isset($_FILES["nuevaFoto"]["tmp_name"])&& !empty($_FILES["nuevaFoto"]["tmp_name"])) {
            ...
            if ($_FILES["nuevaFoto"]["type"]== "image/jpeg") {
                ...
                ====================================== */
                $aleatorio = mt_rand(100,999);
                $rutaEdit = "../vistas/public/img/usuarios/".$_POST["txtUsuario"]."/".$aleatorio.".jpeg";
                $rutaBD = "vistas/public/img/usuarios/".$_POST["txtUsuario"]."/".$aleatorio.".jpeg";
                $origen = imagecreatefromjpeg($_FILES["nuevaFoto"]["tmp_name"]);
                $destino = imagecreatetruecolor($nuevoAncho,$nuevoAlto);
                //imagecopyresized(dst_image,src_image,dst_x,dst_y,src_x,src_y,dst_w,dst_h,src_w,src_h);
            ...
            if ($_FILES["nuevaFoto"]["type"]== "image/png") {
                ...
                ====================================== */
                $aleatorio = mt_rand(100,999);
                $rutaEdit = "../vistas/public/img/usuarios/".$_POST["txtUsuario"]."/".$aleatorio.".png";
                $rutaBD = "vistas/public/img/usuarios/".$_POST["txtUsuario"]."/".$aleatorio.".png";
                $origen = imagecreatefromjpeg($_FILES["nuevaFoto"]["tmp_name"]);
                $destino = imagecreatetruecolor($nuevoAncho,$nuevoAlto);
                //imagecopyresized(dst_image,src_image,dst_x,dst_y,src_x,src_y,dst_w,dst_h,src_w,src_h);
